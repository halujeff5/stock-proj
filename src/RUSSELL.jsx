...
//this is the same as graph on homepage with similiar setup for RUSSELL 2000
export default function RUSSELL() {
    const [loading, setLoading] = useState(false);
    const [currentPrice, setCurrentPrice] = useState({});
    const [symbol, setSymbol] = useState('RTY')
    ...
    return (
        <div className='w-full max-w-4xl bg-white rounded-2xl shadow-md mb-6'>
             <h4 className='mt-4 text-[#014d4e]'>RUSSELL 2000</h4>
